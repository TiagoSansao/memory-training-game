...
public class UnityAdsModule
    extends ReactContextBaseJavaModule /* implements View.OnClickListener, IUnityAdsListener */ {
  ...
  @ReactMethod
  public void test() {
    Log.d("Executed", "Executed function successfully");
    Log.d("Executed", "Executed function successfully");
    Log.d("Executed", "Executed function successfully");
    Log.d("Executed", "Executed function successfully");
    Log.d("Executed", "Executed function successfully");
  ...
  // @Override
  // public void onUnityAdsFinish (String adUnitId, UnityAds.FinishState
  // finishState) {
